...
//import com.imagespace.sql.model.SqlExecType;
...
//            }
//            if (StringUtils.equalsIgnoreCase(type, SqlExecType.EXEC.name())) {
...
//            } else if (StringUtils.equalsIgnoreCase(type, SqlExecType.EXPORT.name())) {
